...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, ButonComponent, HeaderWithLoginComponent, LateralOrangeComponent,
    LoginPageComponent, TextInputComponent, ProfileComponent],
